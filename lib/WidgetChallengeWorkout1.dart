...
//
// class WidgetChallengeWorkout1 extends StatefulWidget {
...
//
//   WidgetChallengeWorkout1(this._modelExerciseList, this._modelDummySend,
//       this.totalCal, this.time, this.day, this.dayModel, this.weekModel);
//
//   @override
//   _WidgetChallengeWorkout1 createState() => _WidgetChallengeWorkout1();
// }
//
...
//   initVideo() async {
//     videoController=
//     VideoPlayerController.network(ConstantUrl.uploadUrl+widget._modelExerciseList.videoUrl!);
...
//
//     print(
//         "timer---$totalTimerTime--$currentTime---${widget._modelExerciseList.exerciseTime!}");
//
//     return Container(
//       height: double.infinity,
//       width: double.infinity,
...
//                               : Center(
//                             child: Container(
//                               margin: EdgeInsets.symmetric(vertical: ConstantWidget
...
//                           widget._modelExerciseList.videoUrl!.isNotEmpty,
//                       child: ValueListenableBuilder(valueListenable: selectedPage, builder: (context, value, child) {
//
//                         return Align(
//                           alignment: Alignment.bottomCenter,
//                           child: Padding(
//                             padding:  EdgeInsets.symmetric(vertical: ConstantWidget
//                                 .getScreenPercentSize(
//                                 context, 2.5)),
...
//                                 pauseTimer();
//                                 showBottomDialog(
//                                     widget._modelExerciseDetail, false);
//                               },
//                               child: SvgPicture.asset(
...
// }
//
// class _WidgetChallengeWorkout1 extends State<WidgetChallengeWorkout1>
//     with WidgetsBindingObserver {
//   int pos = 0;
//   bool isSkip = false;
//   bool isReady = false;
...
//           appBar: getColorStatusBar((pos < widget._modelExerciseList!.length)
//               ? bgColor
//               : bgDarkWhite),
//           body: SafeArea(
...
//
//                       print(
//                           "totaldays-------${widget.dayModel.daysId!}-------weekmodel------${widget.weekModel.weekId!}");
//                       if ((totalDays + 1) == (widget.weekModel.totalDays)) {
//                         addComplete(context, widget.dayModel.weekId!);
//                       }
//
//                       addDayComplete(context, widget.dayModel.daysId!,
...
//                                   Center(
//                                     child: SvgPicture.asset(
//                                       Constants.assetsImagePath + "vector.svg",
//                                       height:
//                                           ConstantWidget.getScreenPercentSize(
//                                               context, 8),
//                                     ),
...
//                               child: ConstantWidget.getButtonWidget(
//                                   context, "Continue", accentColor, () async {

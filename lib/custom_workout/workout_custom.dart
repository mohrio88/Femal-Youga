...
import 'package:flutter_yoga_workout_4_all_new/db/audio_file.dart';
...
class _WidgetSkipData extends State<WidgetSkipData>
  ...
  void showBottomDialog(Customplanexercise exerciseDetail) {
                ...
                children: [
                  Expanded(
                    ...
                    child: ConstantWidget.getCustomTextWidget(
                        exerciseDetail.exercisedetail.exerciseName,
                        Colors.black,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    HtmlWidget(
                      Constants.decode(
                          exerciseDetail.exercisedetail.description),
                      textStyle: TextStyle(
                          wordSpacing: 2,
                          color: textColor,
                          fontSize:
...
class _WorkoutCustom extends State<WorkoutCustom> with WidgetsBindingObserver {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      print("initState==true");
       audioPlayer = new AudioPlayer(context);
      adsFile = new AdsFile(context);

      adsFile!.createInterstitialAd(isv: true);
    });
    _calcTotal();
    super.initState();
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: ConstantWidget.getButtonWidget(
                                  ...
                                  adsFile!.showInterstitialAd(sendToHome,
                                        );
                                }),
                              )
                            ],
  ...
  void sendToHome() {
    sendHomePage(context, 2, isPushReplace: true);
  }

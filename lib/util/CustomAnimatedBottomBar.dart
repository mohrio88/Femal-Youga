...
class _ItemWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    double width= (ConstantWidget.getWidthPercentSize(context, 100)/5);
    return Semantics(
      container: true,
      selected: isSelected,
                    ...
                    children: [
                      Center(
                        child:  SvgPicture.asset(
                          ...
                          height: isSelected?(item.iconSize!*1.3):(item.iconSize!*1.3),
                          color: isSelected?Colors.white:item.inactiveColor,

                        ),
                      ),
                      SizedBox(height: 2,),
                      Text(item.title??"", style: TextStyle(color: isSelected?Colors.white:item.inactiveColor, fontSize: 12),)
                    ],
                  ),
                ),
